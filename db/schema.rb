...
ActiveRecord::Schema[7.0].define(version: 2023_04_14_074522) do
  ...
  create_table "user_notification_timings", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.index ["user_id", "notification_timing_id"], name: "index_u_n_timings_on_u_id_and_n_timing_id", unique: true
